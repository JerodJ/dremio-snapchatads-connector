...
@SourceType(value = "SnapchatAdsARP", label = "SnapchatAds",uiConfig = "snapchatads-layout.json")
public class SnapchatAdsConf extends AbstractArpConf<SnapchatAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/snapchatads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.snapchatads.SnapchatAdsDriver";
